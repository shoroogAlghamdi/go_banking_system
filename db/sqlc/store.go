...
func (store *Store) execTx(ctx context.Context, fn func(*Queries) error) error {
	...
	// same as line 18 but here sending Db transaction cux DBTX accepts both
	q := New(tx)
	err = fn(q)
	if err != nil {
...
func addMoney(
	...
	if err != nil {
		return // since we have static type return in line 183, this is similar to saying return account1, account2, err
	}
